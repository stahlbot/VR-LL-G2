...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SRanipal|Lip")
		static void GetLipWeightings_byEnum(SupportedLipVersion &active_version, TMap<LipShapeEnum, float> &shapes_version1, TMap<LipShapeEnum_v2, float> &shapes_version2);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SRanipal|Lip")
		static void GetLipWeightings_byName(TMap<FName, float> &shapes);
